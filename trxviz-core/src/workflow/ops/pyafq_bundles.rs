...
pub const PYAFQ_BUNDLES: &[PyafqBundleSpec] = &[
    ...
    // Modern pyAFQ subdivides SLF into I/II/III per side (default_bd()).
    // Each has 2 waypoint includes + 1 exclude + a Start endpoint mask;
    // no End mask and no probmap are written for these.
    PyafqBundleSpec {
        display_name: "Left Superior Longitudinal I",
        category: PyafqCategory::Default,
        min_len_mm: Some(40.0),
        max_len_mm: None,
        has_start: true,
    ...
    PyafqBundleSpec {
        display_name: "Left Superior Longitudinal II",
        category: PyafqCategory::Default,
        min_len_mm: Some(40.0),
        max_len_mm: None,
        has_start: true,
    ...
    PyafqBundleSpec {
        display_name: "Left Superior Longitudinal III",
        category: PyafqCategory::Default,
        min_len_mm: Some(40.0),
        max_len_mm: None,
        has_start: true,
    ...
    PyafqBundleSpec {
        display_name: "Right Superior Longitudinal I",
        category: PyafqCategory::Default,
        min_len_mm: Some(40.0),
        max_len_mm: None,
        has_start: true,
    ...
    PyafqBundleSpec {
        display_name: "Right Superior Longitudinal II",
        category: PyafqCategory::Default,
        min_len_mm: Some(40.0),
        max_len_mm: None,
        has_start: true,
    ...
    PyafqBundleSpec {
        display_name: "Right Superior Longitudinal III",
        category: PyafqCategory::Default,
        min_len_mm: Some(40.0),
        max_len_mm: None,
        has_start: true,
